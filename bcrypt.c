...
static char *_crypt_gensalt_blowfish_rn(const char *prefix,
	unsigned long count,
	const char *input, int size, char *output, int output_size);
...
static char *bcrypt_crypt_rn(const char *key, const char *setting,
	void *data, int size)
{
...
int bcrypt_gensalt(int factor, char salt[BCRYPT_HASHSIZE])
{
	...
	aux = bcrypt_crypt_gensalt_rn("$2a$", workf, input, RANDBYTES,
